  ...
  return (
    <footer className="relative bg-black text-white border-t border-white/10">
      ...
      <GlowEffect 
        ...
        className="w-[600px] h-[600px] bottom-0 right-0 opacity-30"
      />
      ...
      <div className="container pt-8 sm:pt-12 text-center px-4">
        <div className="inline-flex items-center space-x-2 mb-6 sm:mb-8">
          ...
          <span className="text-2xl sm:text-3xl font-bold bg-white text-black px-2 sm:px-3 py-1 rounded-md">
            WEBS
          </span>
        </div>
      </div>
      ...
      <div className="container py-8 sm:py-12 text-center relative">
        <div className="relative z-10 max-w-4xl mx-auto px-4">
          <div className="bg-black/40 backdrop-blur-sm border border-white/10 p-4 sm:p-8 rounded-2xl">
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
              <Link href="/contact">
                <Button 
                  size="lg"
                  className="bg-white text-black text-sm sm:text-base px-4 sm:px-8 py-2 sm:py-3"
                >
              ...
              <Link href="/projects">
                <Button 
                  size="lg"
                  variant="outline"
                  className="border-white/20 text-sm sm:text-base px-4 sm:px-8 py-2 sm:py-3"
                >
