...
import ModelStatusIndicator from '@/frontend/components/ModelStatusIndicator';
import ThinkingContainer from '@/frontend/components/ThinkingContainer';
...
export default function NexiousChatbot() {
  ...
  const handleTemperatureChange = (value: number) => {
    ...
    try {
      const { updateModelSettings } = require('@/backend/utils/nexiousAISettings');
      const mode = isProMode ? 'pro' : 'standard';
